...
def _render_supermarket_payload_html(payload: dict[str, Any], *, generated_at: datetime) -> str:
    ...
    tuning = (
        (220, 1410, 52, 760) if len(items) == 1 else
        (220, 1410, 46, 700) if len(items) == 2 else
        (220, 1400, 38, 390) if len(items) <= 4 else
        (218, 1392, 30, 205) if columns == 3 else
        (184, 1410, 23, 130)
    )
    header = payload.get("header") or {}
