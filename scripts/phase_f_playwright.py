...
def main() -> int:
    ...
    for command in ([python, "-m", "alembic", "upgrade", "head"], [python, "scripts/seed_phase_f.py"]):
        result = None
        for _ in range(30):
    ...
    result = {"frontend_probe": {}, "backend_probe": {}, "auth_probe": {}, "builder_options_anonymous_probe": {}, "screenshots": [], "console_errors": console_errors, "page_errors": page_errors, "failed_critical_requests": failed_critical_requests}
    try:
