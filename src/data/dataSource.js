...
function mapCampaignItem(item, suggestions = []) {
  ...
  return {
    ...
    effectiveImageUrl: item.effective_image_url || "",
    effectiveImageSource: item.effective_image_source || "",
    effectiveImageRefreshKey: item.effective_image_refresh_key || "",
    currency: item.currency,
    category: item.category_hint || "-",
    score,
    status: matchStatusLabels[item.match_status] || item.match_status,
    matchStatus: item.match_status,
    image: Boolean(item.effective_image_url),
