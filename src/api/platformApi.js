...
export const platformApi = {
  ...
  downloadMarketProductImportTemplate: (marketId) => downloadPlatformFile(`/platform/markets/${marketId}/catalog-import/template`, "leafletpilot-market-products-template.xlsx"),
  previewMarketProductImport: (marketId, file) => { const body = new FormData(); body.append("workbook", file); return request(`/platform/markets/${marketId}/catalog-import/preview`, { method: "POST", body }); },
  commitMarketProductImport: (marketId, importId, decisions) => request(`/platform/markets/${marketId}/catalog-import/${importId}/commit`, { method: "POST", body: { decisions: decisions || {} } }),
