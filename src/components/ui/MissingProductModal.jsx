...
export function MissingProductModal({ product, onClose, onResolve }) {
  ...
  return (
    <Modal
      ...
      description={`${product.incoming || product.incomingName} için katalog önerilerinden birini seçin veya alternatif aksiyon kullanın.`}
      onClose={onClose}
      footer={
        <>
    ...
    >
      ...
      <div className="modal-action-grid">
        ...
        <Button variant="danger" onClick={() => onResolve("Kampanyadan çıkarıldı")}>
          Kampanyadan çıkar
        </Button>
      </div>
    </Modal>
